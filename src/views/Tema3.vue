  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.fondo-3
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Botiquín de primeros auxilios 
    .row.justify-content-center.mb-5
      .col-lg-8.mb-lg-0.mb-3(data-aos="fade-right")
        p.mb-0 Los botiquines son un recurso indispensable para los primeros auxiliadores, en ellos están todos los elementos necesarios para la atención del paciente. Hay varios tipos de botiquines. A continuación, se darán sugerencias para algunos de ellos. Recuerde que el tipo de botiquín dependerá del entrenamiento y del rol de los auxiliadores o del lugar donde se encuentren. 
      .col-lg-4.col-7: img(src='@/assets/curso/temas/38.png', alt='')
    .titulo-tres: h3 Botiquín para el vehículo 
    p.mb-5 Las lesiones dependerán del lugar ocupado por cada persona dentro del vehículo (conductor, copiloto, parte trasera), del uso o no del cinturón de seguridad o sistemas de retención infantil, de la activación del airbag y de la fuerza del impacto. 
    .row.justify-content-center.mb-5
      .col-lg-10 
        .p-5(style="background-color: #eefad1 ")
          .row.justify-content-center
            .col-lg-6.col-7.mb-lg-0.mb-3: img(src='@/assets/curso/temas/39.png', alt='')
            .col-lg-6
              ul.lista-ul
                li.d-flex
                  i.fas.fa-circle
    ...
    .row.justify-content-center.mb-5.g-0 
      ...
      .col-lg-7
        .p-4.h-100(style="background-color: #d7f38d ")
          .row.justify-content-center
